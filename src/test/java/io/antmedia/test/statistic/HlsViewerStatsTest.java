...
public class HlsViewerStatsTest {
	...
	public void testHLSViewerCount() {
		...
		for (int i = 0; i < 100; i++) {
			...
			viewerStats.registerNewViewer(streamId, sessionId, null, "hls", "127.0.0.1");
		}
	...
	public void testSubscriberEvents() {
		...
		viewerStats.registerNewViewer(streamId, sessionId, subscriberPlay.getSubscriberId(), "hls", "127.0.0.1");
	...
	public void testSetApplicationContextSubscribers() {
		...
		try {
			...
			viewerStats.registerNewViewer(streamId, sessionId, subscriberPlay2.getSubscriberId(), "hls", "127.0.0.1");
			...
			viewerStats.registerNewViewer(streamId, sessionId, subscriberPlay3.getSubscriberId(), "hls", "127.0.0.1");
