...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_ngx_clipboard__ = __webpack_require__("./node_modules/ngx-clipboard/dist/ngx-clipboard.js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return UploadVodDialogComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return BroadcastEditComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return StreamSourceEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var AppPageComponent = /** @class */ (function () {
    ...
    AppPageComponent.prototype.openStreamSourceSettingsDialog = function (selected) {
        ...
        this.selectedBroadcast = selected;
        var dialogRef = this.dialog.open(StreamSourceEditComponent, {
            width: '450px',
            data: {
                name: this.selectedBroadcast.name,
                url: this.selectedBroadcast.ipAddr,
...
var CamSettinsDialogComponent = /** @class */ (function () {
    ...
    CamSettinsDialogComponent = __decorate([
        ...
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_8__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["d" /* RestService */], Object])
...
var StreamSourceEditComponent = /** @class */ (function () {
    ...
    StreamSourceEditComponent.prototype.editSettings = function (isValid) {
        ...
        this.loadingSettings = true;
        console.log(this.dialogRef.componentInstance.data.status + this.dialogRef.componentInstance.data.id + this.dialogRef.componentInstance.data.name + this.dialogRef.componentInstance.data.url + this.dialogRef.componentInstance.data.username);
        this.streamSource = new __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["c" /* LiveBroadcast */]();
    ...
    StreamSourceEditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            ...
            template: __webpack_require__("./src/app/app.page/streamSource-settings-dialog.html"),
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_8__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["d" /* RestService */], Object])
...
var DetectedObjectListDialog = /** @class */ (function () {
    function DetectedObjectListDialog(dialogRef, restService, data) {
        ...
        this.timerId = window.setInterval(function () {
            _this.getDetectionList(_this.appName, data.streamId, _this.detectedListOffset, _this.pageSize);
        }, 5000);
