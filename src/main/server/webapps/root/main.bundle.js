...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__rest_cluster_service__ = __webpack_require__("./src/app/rest/cluster.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_ngx_clipboard__ = __webpack_require__("./node_modules/ngx-clipboard/dist/ngx-clipboard.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__locale_locale__ = __webpack_require__("./src/app/locale/locale.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__app_page_app_page_component__ = __webpack_require__("./src/app/app.page/app.page.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_19__app_page_app_page_component__["a" /* AppPageComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_15__rest_cluster_service__["a" /* ClusterRestService */],
                __WEBPACK_IMPORTED_MODULE_18__locale_locale__["a" /* Locale */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__rest_auth_service__ = __webpack_require__("./src/app/rest/auth.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__locale_locale__ = __webpack_require__("./src/app/locale/locale.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dialog_detected_objects_list__ = __webpack_require__("./src/app/app.page/dialog/detected.objects.list.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__dialog_upload_vod_dialog__ = __webpack_require__("./src/app/app.page/dialog/upload-vod-dialog.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__dialog_stream_source_edit_component__ = __webpack_require__("./src/app/app.page/dialog/stream.source.edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__dialog_broadcast_edit_dialog_component__ = __webpack_require__("./src/app/app.page/dialog/broadcast.edit.dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__dialog_cam_settings_dialog_component__ = __webpack_require__("./src/app/app.page/dialog/cam.settings.dialog.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__dialog_social_media_stats_component__ = __webpack_require__("./src/app/app.page/dialog/social.media.stats.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var flowplayer = __webpack_require__("./node_modules/flowplayer/dist/flowplayer.js");
var engine = __webpack_require__("./node_modules/flowplayer-hlsjs/flowplayer.hlsjs.js");
engine(flowplayer);
...
var AppSettings = /** @class */ (function () {
    function AppSettings(mp4MuxingEnabled, addDateTimeToMp4FileName, hlsMuxingEnabled, hlsListSize, hlsTime, hlsPlayListType, facebookClientId, facebookClientSecret, youtubeClientId, youtubeClientSecret, periscopeClientId, periscopeClientSecret, encoderSettings, acceptOnlyStreamsInDataStore, vodFolder, objectDetectionEnabled, tokenControlEnabled) {
...
var AppPageComponent = /** @class */ (function () {
    function AppPageComponent(http, route, restService, clipBoardService, renderer, router, zone, dialog, sanitizer, cdr, matpage, authService) {
        this.http = http;
        this.route = route;
        ...
        this.displayedColumnsStreams = ['name', 'status', 'viewerCount', 'social_media', 'actions'];
        ...
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_8__angular_material__["I" /* MatTableDataSource */]();
        this.dataSourceVod = new __WEBPACK_IMPORTED_MODULE_8__angular_material__["I" /* MatTableDataSource */]();
    }
    ...
    AppPageComponent.prototype.onPaginateChange = function (event) {
        ...
        this.restService.getVodList(this.appName, this.vodListOffset, this.pageSize).subscribe(function (data) {
            ...
            _this.dataSourceVod = new __WEBPACK_IMPORTED_MODULE_8__angular_material__["I" /* MatTableDataSource */](_this.vodTableData.dataRows);
        });
    };
    ...
    AppPageComponent.prototype.openSettingsDialog = function (selected) {
        ...
        if (selected.endPointList != null) {
            ...
            selected.endPointList.forEach(function (element) {
                switch (element.type) {
                    case "facebook":
        ...
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_14__dialog_cam_settings_dialog_component__["a" /* CamSettingsDialogComponent */], {
            width: '300px',
            data: {
    ...
    AppPageComponent.prototype.showLiveComments = function (broadcast) {
        this.dialog.open(__WEBPACK_IMPORTED_MODULE_15__dialog_social_media_stats_component__["a" /* SocialMediaStatsComponent */], {
            width: '90%',
            data: {
                appName: this.appName,
    ...
    AppPageComponent.prototype.openStreamSourceSettingsDialog = function (selected) {
        var _this = this;
        if (selected.endPointList != null) {
            this.editBroadcastShareFacebook = false;
            this.editBroadcastShareYoutube = false;
        ...
        this.selectedBroadcast = selected;
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_12__dialog_stream_source_edit_component__["a" /* StreamSourceEditComponent */], {
            width: '450px',
            data: {
                name: this.selectedBroadcast.name,
                url: this.selectedBroadcast.ipAddr,
    ...
    AppPageComponent.prototype.hasSocialEndpoint = function (broadcast) {
        var hasEndpoint = false;
        if (broadcast.endPointList) {
            for (var _i = 0, _a = broadcast.endPointList; _i < _a.length; _i++) {
                var item = _a[_i];
    ...
    AppPageComponent.prototype.openVodUploadDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_11__dialog_upload_vod_dialog__["a" /* UploadVodDialogComponent */], {
    ...
    AppPageComponent.prototype.openBroadcastEditDialog = function (stream) {
        ...
        if (this.liveStreamEditing) {
            var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_13__dialog_broadcast_edit_dialog_component__["a" /* BroadcastEditComponent */], {
                data: {
    ...
    AppPageComponent.prototype.getAppLiveStreams = function (offset, size) {
        ...
        this.restService.getAppLiveStreams(this.appName, offset, size).subscribe(function (data) {
            ...
            _this.dataSource = new __WEBPACK_IMPORTED_MODULE_8__angular_material__["I" /* MatTableDataSource */](_this.broadcastTableData.dataRows);
        });
    };
    ...
    AppPageComponent.prototype.importLiveStreams2Stalker = function () {
        ...
        this.restService.importLiveStreams2Stalker(this.appName).subscribe(function (data) {
            ...
            var message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().streams_imported_successfully;
            var type = "success";
            var delay = 500;
            var icon = "ti-save";
            if (!data["success"]) {
                icon = "ti-alert";
                if (data["errorId"] == 404) {
                    message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().missing_configuration_parameter_for_stalker;
                }
                else {
                    message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().error_occured;
                }
                type = "warning";
                delay = 1900;
            }
    ...
    AppPageComponent.prototype.showDetectedObject = function (streamId) {
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_10__dialog_detected_objects_list__["a" /* DetectedObjectListDialog */], {
            width: '500px',
            height: '500px',
            data: {
                streamId: streamId,
    ...
    AppPageComponent.prototype.playLive = function (streamId) {
        ...
        setTimeout(function () {
            if (_this.appSettings.tokenControlEnabled) {
                iframeSource = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + "/play.html?name=" + streamId + "&token=" + _this.token.tokenId + "&autoplay=true";
            }
            else {
    ...
    AppPageComponent.prototype.playVoD = function (vodName, type, vodId, streamId) {
        ...
        setTimeout(function () {
            ...
            if (!_this.appSettings.tokenControlEnabled) {
                if (type == "uploadedVod") {
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + vodId + '.mp4';
                }
                else if (type == "streamVod") {
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + vodName;
                }
                else if (type == "userVod") {
                    var lastSlashIndex = _this.appSettings.vodFolder.lastIndexOf("/");
                    var folderName = _this.appSettings.vodFolder.substring(lastSlashIndex);
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + folderName + '/' + vodName;
                }
            }
            else {
                if (type == "uploadedVod") {
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + vodId + '.mp4?token=' + _this.token.tokenId;
                }
                else if (type == "streamVod") {
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + vodName + '?token=' + _this.token.tokenId;
                }
                else if (type == "userVod") {
                    var lastSlashIndex = _this.appSettings.vodFolder.lastIndexOf("/");
                    var folderName = _this.appSettings.vodFolder.substring(lastSlashIndex);
                    srcFile = __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + _this.appName + '/streams/' + folderName + '/' + vodName + '?token=' + _this.token.tokenId;
                }
            }
            if (srcFile != null) {
                swal({
    ...
    //file with extension
    AppPageComponent.prototype.deleteVoD = function (fileName, vodId, type) {
        var _this = this;
        swal({
            title: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().are_you_sure,
            text: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().wont_be_able_to_revert,
            type: 'warning',
            ...
            _this.restService.deleteVoDFile(_this.appName, fileName, vodId, type).subscribe(function (data) {
                if (data["success"] == true) {
                    $.notify({
                        icon: "ti-save",
                        message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().vod_deleted
                    }, {
                        type: "success",
                        delay: 900,
                        placement: {
    ...
    AppPageComponent.prototype.showVoDFileNotDeleted = function () {
        $.notify({
            icon: "ti-save",
            message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().vodFileNotDeleted
        }, {
            type: "warning",
            delay: 900,
            placement: {
    ...
    AppPageComponent.prototype.updateLiveStream = function (isValid) {
        ...
        this.restService.updateLiveStream(this.appName, this.liveStreamEditing, socialNetworks).subscribe(function (data) {
            ...
            if (data["success"]) {
                ...
                $.notify({
                    icon: "ti-save",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().broadcast_updated
                }, {
                    type: "success",
                    delay: 900,
                    placement: {
                ...
                $.notify({
                    icon: "ti-alert",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().broadcast_not_updated + " " + data["message"] + " " + data["errorId"]
                }, {
                    type: "warning",
                    delay: 900,
                    placement: {
    ...
    AppPageComponent.prototype.deleteLiveBroadcast = function (streamId) {
        ...
        swal({
            ...
            _this.restService.deleteBroadcast(_this.appName, streamId)
                ...
                if (data["success"] == true) {
                    _this.restService.stopBroadcast(_this.appName, streamId);
                    $.notify({
                        icon: "ti-save",
                    ...
                    $.notify({
                        icon: "ti-save",
                        message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().broadcast_not_deleted
                    }, {
                        type: "warning",
                        delay: 900,
                        placement: {
    ...
    AppPageComponent.prototype.getToken = function (streamId) {
        var _this = this;
        this.token = null;
        this.restService.getToken(this.appName, streamId, 0).subscribe(function (data) {
            _this.token = data;
        });
    };
    AppPageComponent.prototype.changeSettings = function (valid) {
        ...
        this.restService.changeSettings(this.appName, this.appSettings).subscribe(function (data) {
            if (data["success"] == true) {
                $.notify({
                    icon: "ti-save",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().settings_saved
                }, {
                    type: "success",
                    delay: 900,
                    placement: {
                ...
                $.notify({
                    icon: "ti-alert",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().settings_not_saved
                }, {
                    type: 'warning',
                    delay: 1900,
                    placement: {
    ...
    AppPageComponent.prototype.addIPCamera = function (isValid) {
        ...
        this.restService.addStreamSource(this.appName, this.liveBroadcast)
            ...
            if (data["success"] == true) {
                ...
                $.notify({
                    icon: "ti-save",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().new_broadcast_created
                }, {
                    type: "success",
                    delay: 1000,
                    placement: {
                ...
                $.notify({
                    icon: "ti-save",
                    message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().new_broadcast_error
                }, {
                    type: "warning",
                    delay: 2000,
                    placement: {
        ...
        setTimeout(function () {
            _this.restService.getCameraError(_this.appName, _this.liveBroadcast.ipAddr).subscribe(function (data) {
                console.log("stream ID :  " + _this.liveBroadcast.ipAddr);
    ...
    AppPageComponent.prototype.getSocialMediaAuthParameters = function (networkName) {
        ...
        this.restService.getDeviceAuthParameters(this.appName, networkName).subscribe(function (data) {
            if (data['verification_url']) {
                ...
                var message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().copy_this_code_and_enter_the_url.replace("CODE_KEY", data['user_code']);
                ...
                message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().notEnterprise;
                typem = 'error';
                _this.gettingDeviceParameters = false;
                swal({
                    html: message,
                ...
                message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().ketNotdefined;
                typem = 'error';
                _this.gettingDeviceParameters = false;
                swal({
                    html: message,
    ...
    AppPageComponent.prototype.copyPublishUrl = function (streamUrl) {
        ...
        $.notify({
            message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().publish_url_copied_to_clipboard
        }, {
            type: "success",
            delay: 400,
            timer: 500,
    ...
    AppPageComponent.prototype.copyLiveEmbedCode = function (streamUrl) {
        ...
        $.notify({
            message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().embed_code_copied_to_clipboard
        }, {
            type: "success",
            delay: 400,
            timer: 500,
    ...
    AppPageComponent.prototype.copyVoDEmbedCode = function (name) {
        var lastSlashIndex = name.lastIndexOf(".mp4");
        var VoDName = name.substring(0, lastSlashIndex);
        var embedCode = '<iframe width="560" height="315" src="'
            + __WEBPACK_IMPORTED_MODULE_4__rest_rest_service__["b" /* HTTP_SERVER_ROOT */] + this.appName + "/play.html?name=" + VoDName
            + '" frameborder="0" allowfullscreen></iframe>';
        this.clipBoardService.copyFromContent(embedCode);
        $.notify({
            message: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().embed_code_copied_to_clipboard
        ...
        this.restService.checkAuthStatus(userCode, this.appName).subscribe(function (data) {
            if (data["success"] != true) {
                if (data["message"] == null) {
                    ...
                    var message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().error_occured;
                    if (data["message"] == LIVE_STREAMING_NOT_ENABLED) {
                        message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().live_streaming_not_enabled_message;
                    }
                    else if (data["message"] == AUTHENTICATION_TIMEOUT) {
                        message = __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().authentication_timeout_message;
                    }
                    swal({
                        type: "warning",
                ...
                if (networkName == "facebook") {
                    ...
                    swal({
                        type: "success",
                        title: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().congrats,
                        text: __WEBPACK_IMPORTED_MODULE_7__locale_locale__["a" /* Locale */].getLocaleInterface().authentication_is_done,
                    });
                }
            }
        });
    ...
    __decorate([
        ...
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_8__angular_material__["N" /* PageEvent */])
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_8__angular_material__["F" /* MatSort */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_8__angular_material__["F" /* MatSort */])
    ...
    AppPageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_6_ngx_clipboard__["b" /* ClipboardService */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__angular_material__["u" /* MatPaginatorIntl */],
            __WEBPACK_IMPORTED_MODULE_5__rest_auth_service__["a" /* AuthService */]])
    ], AppPageComponent);
...
/***/ "./src/app/app.page/dialog/broadcast.edit.dialog.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/app.page/dialog/broadcast.edit.dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BroadcastEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__locale_locale__ = __webpack_require__("./src/app/locale/locale.ts");
...
var BroadcastEditComponent = /** @class */ (function () {
    ...
    BroadcastEditComponent.prototype.updateLiveStream = function (isValid) {
        ...
        this.liveStreamEditing = new __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["c" /* LiveBroadcast */]();
        ...
        this.restService.updateLiveStream(this.dialogRef.componentInstance.data.appName, this.liveStreamEditing, socialNetworks).subscribe(function (data) {
            ...
            if (data["success"]) {
                ...
                $.notify({
                    icon: "ti-save",
                    message: __WEBPACK_IMPORTED_MODULE_1__locale_locale__["a" /* Locale */].getLocaleInterface().broadcast_updated
                }, {
                    type: "success",
                    delay: 900,
                    placement: {
                ...
                $.notify({
                    icon: "ti-alert",
                    message: __WEBPACK_IMPORTED_MODULE_1__locale_locale__["a" /* Locale */].getLocaleInterface().broadcast_not_updated + " " + data["message"] + " " + data["errorId"]
                }, {
                    type: "warning",
                    delay: 900,
                    placement: {
    ...
    BroadcastEditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            ...
            template: __webpack_require__("./src/app/app.page/dialog/broadcast.edit.dialog.component.html"),
        }),
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["d" /* RestService */], Object])
...
/***/ "./src/app/app.page/dialog/cam.settings.dialog.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/app.page/dialog/cam.settings.dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CamSettingsDialogComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__locale_locale__ = __webpack_require__("./src/app/locale/locale.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__ = __webpack_require__("./src/app/rest/rest.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material__ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
...
var CamSettingsDialogComponent = /** @class */ (function () {
    function CamSettingsDialogComponent(dialogRef, restService, data) {
        var _this = this;
        this.dialogRef = dialogRef;
        this.restService = restService;
        this.data = data;
    ...
    CamSettingsDialogComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    CamSettingsDialogComponent.prototype.cancelEditLiveStream = function () {
        this.dialogRef.close();
    };
    CamSettingsDialogComponent.prototype.editCamSettings = function (isValid) {
        var _this = this;
        if (!isValid) {
            return;
        }
        ...
        this.camera = new __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["c" /* LiveBroadcast */]();
        ...
        setTimeout(function () {
            _this.restService.getCameraError(_this.appName, _this.camera.ipAddr).subscribe(function (data) {
                console.log("stream ID :  " + _this.camera.ipAddr);
                if (data["message"] != null) {
                    if (data["message"].includes("401")) {
                        swal({
                            title: "Authorization Error",
    ...
    CamSettingsDialogComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            selector: 'dialog-overview-example-dialog',
            template: __webpack_require__("./src/app/app.page/dialog/cam.settings.dialog.component.html"),
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_3__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["d" /* RestService */], Object])
    ], CamSettingsDialogComponent);
    return CamSettingsDialogComponent;
}());
...
module.exports = "<div *ngIf=!noDetectedObject>\n<h2 mat-dialog-title>Object Detection List</h2>\n<mat-table [dataSource]=\"dataSource\" matSort >\n\n\n    <ng-container matColumnDef=\"image\">\n        <mat-header-cell *matHeaderCellDef> Image </mat-header-cell>\n\n        <mat-cell *matCellDef=\"let row\" style=\"padding:10px\">\n\n            <a [href]=\"getImageURL(row.imageId)\" target=\"_blank\"> <img style=\"width:30%;\" [src]=\"getImageURL(row.imageId)\"> </a>\n            {{row.objectName}} - {{row.detectionTime | date:'medium'}}\n\n        </mat-cell>\n    </ng-container>\n\n    <ng-container matColumnDef=\"time\">\n            <mat-header-cell *matHeaderCellDef > Time </mat-header-cell>\n    \n            <mat-cell *matCellDef=\"let row\" style=\"padding:10px\">\n    \n                {{row.detectionTime}}\n    \n            </mat-cell>\n        </ng-container>\n\n\n    <mat-header-row *matHeaderRowDef=\"displayedColumnsStreams\"></mat-header-row>\n    <mat-row *matRowDef=\"let row; columns: displayedColumnsStreams;\">\n    </mat-row>\n</mat-table>\n\n\n   <mat-paginator   \n    [length]=\"detectedLenght\"\n    [pageSize]=\"pageSize\"\n    [pageSizeOptions]=\"pageSizeOptions\"\n    (page)=\"onDetectionPaginateChange($event)\"\n    >\n    </mat-paginator>\n\n<!--<mat-paginator #paginator [pageSize]=\"100\" [pageSizeOptions]=\"[5, 10, 20]\" [showFirstLastButtons]=\"true\">\n</mat-paginator>\n-->\n\n\n</div>\n<div *ngIf=noDetectedObject>\n  <h5>     No detected object for the stream!</h5>\n\n</div>\n\n<br>\n<button type=\"button\" class=\"btn btn-simple\" i18n=\"@@newLiveStreamCancelButton\" (click)=\"onNoClick()\">Close</button>"
...
var DetectedObjectListDialog = /** @class */ (function () {
    function DetectedObjectListDialog(dialogRef, restService, data) {
        ...
        this.restService = restService;
        this.data = data;
        this.detectedLenght = 100;
        this.pageSize = 5;
        this.pageSizeOptions = [5, 10, 20];
        this.detectedListOffset = 0;
    ...
    DetectedObjectListDialog.prototype.ngOnInit = function () {
        this.objectTableData = {
            dataRows: []
        };
    };
    DetectedObjectListDialog.prototype.getObjectDetectedTotal = function (appName, streamId) {
        var _this = this;
        this.restService.getObjectDetectedTotal(appName, streamId).subscribe(function (data) {
            _this.detectedLenght = parseInt(data.toString());
        });
    };
    DetectedObjectListDialog.prototype.getDetectionList = function (appName, streamId, offset, batch) {
        ...
        this.restService.getDetectionList(appName, streamId, offset, batch).subscribe(function (data) {
            for (var i in data) {
                _this.objectTableData.dataRows.push(data[i]);
            }
            _this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["I" /* MatTableDataSource */](_this.objectTableData.dataRows);
            console.log(" detected object number " + _this.objectTableData.dataRows.length);
            if (_this.objectTableData.dataRows.length == 0) {
                _this.noDetectedObject = true;
            }
        });
    };
    DetectedObjectListDialog.prototype.onDetectionPaginateChange = function (event) {
        var _this = this;
        this.detectedListOffset = event.pageIndex * event.pageSize;
        this.pageSize = event.pageSize;
        this.restService.getDetectionList(this.appName, this.data.streamId, this.detectedListOffset, this.pageSize).subscribe(function (data) {
            _this.objectTableData.dataRows = [];
            for (var i in data) {
                _this.objectTableData.dataRows.push(data[i]);
            }
            _this.dataSource = new __WEBPACK_IMPORTED_MODULE_1__angular_material__["I" /* MatTableDataSource */](_this.objectTableData.dataRows);
...
/***/ "./src/app/app.page/dialog/social.media.stats.component.html":
/***/ (function(module, exports) {

module.exports = "<h1 mat-dialog-title>Social Media Stats</h1>\n\n<mat-grid-list cols=\"4\" rowHeight=\"70px\">\n    <ng-container *ngFor=\"let typeName of endpointTypes\">\n        <mat-grid-tile>\n            <mat-grid-list cols=\"3\" rowHeight=\"70px\" style=\"width:100%\">\n                <mat-grid-tile>\n                    <div class=\"text-center\" style=\"font-size:1.8em\">\n                        <ng-container [ngSwitch]=\"typeName\">\n                            <i class=\"ti-facebook\" style=\"color:#3b5998;\" *ngSwitchCase=\"'facebook'\"> </i>\n                            <i class=\"ti-youtube\" style=\"color:#e52d27;\" *ngSwitchCase=\"'youtube'\"> </i>\n                            <i class=\"ti-twitter-alt\" style=\"color:#55acee;\" *ngSwitchCase=\"'periscope'\"></i>\n                        </ng-container>\n                    </div>\n                </mat-grid-tile>\n                <mat-grid-tile colspan=\"1\">\n                    <span style=\"width:100%\">\n                        <p style=\"font-size:12px;line-height: 12px;\"> Comments: {{commentCount[typeName]}} </p>\n                        <p style=\"font-size:12px;line-height: 12px;\"> Likes: {{likeCount[typeName]}} </p>\n                        <p style=\"font-size:12px;line-height: 12px;\" *ngIf=\"viewCount[typeName] > 0\"> Views:{{viewCount[typeName]}} </p>\n                    </span>\n                </mat-grid-tile>\n            </mat-grid-list>\n\n        </mat-grid-tile>\n    </ng-container>\n</mat-grid-list>\n\n\n<mat-dialog-content id=\"comment-list\">\n    <b style=\"display:block;padding-top:24px;\" *ngIf=\"comments.length > 0\">Live Comments</b>\n    <mat-list>\n        <mat-list-item *ngFor=\"let comment of comments\">\n            <img matListAvatar [src]=\"comment.from.picture\">\n            <h3 matLine> {{comment.from.fullName}}\n                <ng-container [ngSwitch]=\"comment.origin\">\n                    <i class=\"ti-facebook\" style=\"color:#3b5998;\" *ngSwitchCase=\"'FACEBOOK'\"> </i>\n                    <i class=\"ti-youtube\" style=\"color:#e52d27;\" *ngSwitchCase=\"'YOUTUBE'\"> </i>\n                    <i class=\"ti-twitter-alt\" style=\"color:#55acee;\" *ngSwitchCase=\"'PERISCOPE'\"></i>\n                </ng-container>\n            </h3>\n            <p matLine> {{comment.message}} </p>\n        </mat-list-item>\n    </mat-list>\n</mat-dialog-content>\n<mat-dialog-actions class=\"pull-right\">\n    <button mat-button mat-dialog-close>Close</button>\n</mat-dialog-actions>"

/***/ }),

/***/ "./src/app/app.page/dialog/social.media.stats.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SocialMediaStatsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var SocialMediaStatsComponent = /** @class */ (function () {
    function SocialMediaStatsComponent(dialogRef, restService, data) {
        var _this = this;
        this.dialogRef = dialogRef;
        this.restService = restService;
        this.data = data;
        ...
        this.comments = [];
        this.data.endpointList.forEach(function (item, index) {
            if (item.endpointServiceId) {
                _this.endpointList.push(item);
                _this.serviceCommentCount[item.endpointServiceId] = 0;
                if (!_this.endpointTypes.includes(item.type)) {
                    _this.endpointTypes.push(item.type);
                    _this.likeCount[item.type] = 0;
                    _this.viewCount[item.type] = 0;
                    _this.commentCount[item.type] = 0;
                }
            }
        });
        this.getStats();
    ...
    SocialMediaStatsComponent.prototype.getStats = function () {
        var _this = this;
        for (var _i = 0, _a = this.endpointTypes; _i < _a.length; _i++) {
            var typeName = _a[_i];
            this.tempViewCount[typeName] = 0;
            this.tempLikeCount[typeName] = 0;
            this.tempCommentCount[typeName] = 0;
        }
        this.restService.getBroadcast(this.appName, this.streamId).subscribe(function (data) {
        ...
        var _loop_1 = function (element) {
            this_1.restService.getLiveCommentsCount(this_1.appName, this_1.streamId, element.endpointServiceId)
                .subscribe(function (data) {
                console.debug(" live comments count " + data["message"]);
                var liveCommentCount = parseInt(data["message"]);
                _this.tempCommentCount[element.type] += liveCommentCount;
                if (_this.serviceCommentCount[element.endpointServiceId] < liveCommentCount) {
                    var batchSize = liveCommentCount - _this.serviceCommentCount[element.endpointServiceId];
                    var offset = _this.serviceCommentCount[element.endpointServiceId];
                    _this.serviceCommentCount[element.endpointServiceId] = liveCommentCount;
                    _this.restService.getLiveComments(_this.appName, _this.streamId, element.endpointServiceId, offset, batchSize)
                        .subscribe(function (data) {
                        for (var i in data) {
                ...
                tempCommentCalled++;
                if (tempCommentCalled == _this.endpointList.length) {
                    for (var _i = 0, _a = _this.endpointTypes; _i < _a.length; _i++) {
                        var typeName = _a[_i];
                        _this.commentCount[typeName] = _this.tempCommentCount[typeName];
                    }
                }
            });
            this_1.restService.getLiveViewsCount(this_1.appName, this_1.streamId, element.endpointServiceId)
                .subscribe(function (data) {
                console.debug("new live views count " + data["message"]);
                _this.tempViewCount[element.type] += parseInt(data["message"]);
                tempViewCalled++;
                if (tempViewCalled == _this.endpointList.length) {
                    for (var _i = 0, _a = _this.endpointTypes; _i < _a.length; _i++) {
                        var typeName = _a[_i];
                        _this.viewCount[typeName] = _this.tempViewCount[typeName];
                    }
                }
            });
            this_1.restService.getInteraction(this_1.appName, this_1.streamId, element.endpointServiceId)
                .subscribe(function (data) {
                if (data != null) {
                    console.debug(" like count " + data["likeCount"]);
                    _this.tempLikeCount[element.type] += parseInt(data["likeCount"])
                        + parseInt(data["loveCount"])
                        + parseInt(data["hahaCount"])
                        + parseInt(data["wowCount"]);
                    tempLikeCalled++;
                    if (tempLikeCalled == _this.endpointList.length) {
                        for (var _i = 0, _a = _this.endpointTypes; _i < _a.length; _i++) {
                            var typeName = _a[_i];
                            _this.likeCount[typeName] = _this.tempLikeCount[typeName];
                        }
                    }
                }
            });
        ...
        var this_1 = this;
        for (var _b = 0, _c = this.endpointList; _b < _c.length; _b++) {
            var element = _c[_b];
            _loop_1(element);
        }
    };
    SocialMediaStatsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            selector: 'social-media-stats-component',
            template: __webpack_require__("./src/app/app.page/dialog/social.media.stats.component.html"),
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_2__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_1__rest_rest_service__["d" /* RestService */], Object])
    ], SocialMediaStatsComponent);
    return SocialMediaStatsComponent;
}());
...
/***/ "./src/app/app.page/dialog/stream.source.edit.component.html":
/***/ (function(module, exports) {

module.exports = "\n<div >\n    <td colspan=\"4\" style=\"border-top:0px\">\n        <form method=\"post\" #f=\"ngForm\" validate (ngSubmit)=\"editSettings(f.valid)\">\n\n            <div class=\"card-content\" style=\"padding-top:0px\">\n                <h4 class=\"card-title text-left\" i18n=\"@@editLiveStreamCardTitle\">\n                    Edit Stream Source\n                </h4>\n                <div class=\"form-group text-left\">\n                    <label i18n=\"@@newCamName\">Name</label>\n                    <input type=\"text\" required minlength=\"4\" name=\"broadcastName\"\n                           i18n-placeholder=\"@@stream_name_place_holder\" placeholder=\"Stream name\"\n                           class=\"form-control\" [(ngModel)]=\"data.name\" #broadcastName=\"ngModel\">\n                    <small [hidden]=\"broadcastName.valid || (!f.submitted)\" class=\"text-danger\"\n                           i18n=\"@@broadcastNameIsRequired\">\n                        Camera name should be at least 4 characters.\n                    </small>\n\n                    <small class=\"text-danger\" *ngIf=\"streamNameEmpty\">\n                        Stream name should not be empty.\n                    </small>\n                </div>\n\n                <div class=\"form-group text-left\">\n                    <label i18n=\"@@newStreamUrl\">Stream Url</label>\n                    <input type=\"text\" name=\"streamUrl\" i18n-placeholder=\"@@onvif_url_place_holder\" placeholder=\"Stream Url\"\n                           class=\"form-control\" [(ngModel)]=\"data.streamUrl\" #onvifUrl=\"ngModel\" style=\"width: 400px\">\n\n                    <small class=\"text-danger\" *ngIf=\"!streamUrlDialogValid\">\n                        Please write a valid stream URL\n                    </small>\n\n\n\n                </div>\n\n                <div class=\"form-group text-left\" *ngIf=\"data.videoServiceEndpoints.length>0\" >\n                    <label class=\"col-sm-12\" style=\"padding-left:0px\" i18n=\"@@newLiveStreamSocialShare\">Share</label>\n\n                    <ng-container *ngFor=\"let endpoint of data.videoServiceEndpoints; let i = index\">\n\n                        <div class=\"col-sm-4 text-left checkbox vcenter\" style=\"margin-top:5px\">\n\n                            <input [id]=\"endpoint.id\" [name]=\"endpoint.id\" type=\"checkbox\"\n                                   [(ngModel)]=\"shareEndpoint[i]\">\n                            <label [for]=\"endpoint.id\">\n                                <ng-container [ngSwitch]=\"endpoint.serviceName\">\n                                    <ng-container *ngSwitchCase=\"'facebook'\">\n                                        <i class=\"ti-facebook\" style=\"color:#3b5998\">&nbsp;</i>\n                                    </ng-container>\n                                    <ng-container *ngSwitchCase=\"'youtube'\">\n                                        <i class=\"ti-youtube\" style=\"color:#e52d27\">&nbsp;</i>\n                                    </ng-container>\n                                    <ng-container *ngSwitchCase=\"'periscope'\">\n                                        <i class=\"ti-twitter-alt\" style=\"color:#55acee\">&nbsp;</i>\n                                    </ng-container>\n                                </ng-container>\n                                {{endpoint.accountName}}\n                            </label>\n\n                        </div>\n                    </ng-container>\n\n                </div>\n\n\n                <div>\n\n                    <button type=\"submit\" class=\"btn btn-fill btn-success\" i18n=\"@@newLiveStreamSaveButton\">\n                        <i class=\"fa fa-spinner fa-pulse fa-1x fa-fw\" *ngIf=\"loadingSettings\" aria-hidden=\"true\"></i>Save\n                    </button>\n\n                    <button type=\"button\" class=\"btn btn-simple\" i18n=\"@@newLiveStreamCancelButton\" (click)=\"cancelEditLiveStream()\">Cancel</button>\n                </div>\n\n            </div>\n\n        </form>\n    </td>\n</div>\n\n"

/***/ }),

/***/ "./src/app/app.page/dialog/stream.source.edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StreamSourceEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__locale_locale__ = __webpack_require__("./src/app/locale/locale.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__ = __webpack_require__("./src/app/rest/rest.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material__ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
...
var StreamSourceEditComponent = /** @class */ (function () {
    function StreamSourceEditComponent(dialogRef, restService, data) {
        var _this = this;
        this.dialogRef = dialogRef;
        this.restService = restService;
        this.data = data;
    ...
    StreamSourceEditComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    StreamSourceEditComponent.prototype.cancelEditLiveStream = function () {
        this.dialogRef.close();
    };
    StreamSourceEditComponent.prototype.editSettings = function (isValid) {
        var _this = this;
        this.streamUrlDialogValid = true;
        if (!isValid) {
            return;
        ...
        console.log(this.dialogRef.componentInstance.data.status + this.dialogRef.componentInstance.data.id + this.dialogRef.componentInstance.data.name + this.dialogRef.componentInstance.data.url + this.dialogRef.componentInstance.data.username);
        this.streamSource = new __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["c" /* LiveBroadcast */]();
        ...
        if (this.restService.checkStreamUrl(this.streamSource.streamUrl)) {
            this.restService.editCameraInfo(this.streamSource, this.dialogRef.componentInstance.data.appName).subscribe(function (data) {
                if (data["success"]) {
                    _this.dialogRef.close();
                    $.notify({
                        icon: "ti-save",
    ...
    StreamSourceEditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            selector: 'streamSource-edit-dialog',
            template: __webpack_require__("./src/app/app.page/dialog/stream.source.edit.component.html"),
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_3__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["d" /* RestService */], Object])
    ], StreamSourceEditComponent);
    return StreamSourceEditComponent;
}());
...
/***/ "./src/app/app.page/dialog/upload-vod-dialog.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/app.page/dialog/upload-vod-dialog.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UploadVodDialogComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__("./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__ = __webpack_require__("./src/app/rest/rest.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var UploadVodDialogComponent = /** @class */ (function () {
    ...
    UploadVodDialogComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            ...
            template: __webpack_require__("./src/app/app.page/dialog/upload-vod-dialog.html"),
        }),
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_1__angular_material__["a" /* MAT_DIALOG_DATA */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["k" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["d" /* RestService */], Object])
    ...
    AuthService.prototype.checkServerIsAuthenticated = function () {
        ...
        if (localStorage.getItem('authenticated')) {
            this.restService.isAuthenticated().subscribe(function (data) {
                ...
                if (_this.router.url == "/pages/login") {
                    _this.router.navigateByUrl('/dashboard/overview');
                }
            }, function (error) {
...
/***/ "./src/app/rest/cluster.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export SERVER_ADDR */
/* unused harmony export HTTP_SERVER_ROOT */
/* unused harmony export REST_SERVICE_ROOT */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClusterRestService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
...
var REST_SERVICE_ROOT = HTTP_SERVER_ROOT + "ConsoleApp/rest/cluster";
var ClusterRestService = /** @class */ (function () {
    function ClusterRestService(http, router) {
        this.http = http;
        this.router = router;
    }
    ClusterRestService.prototype.handleError = function (error) {
        if (error.status == 401) {
    ...
    ClusterRestService.prototype.getClusterNodes = function () {
        return this.http.get(REST_SERVICE_ROOT + '/nodes');
    };
    ClusterRestService.prototype.updateClusterNodes = function (node) {
        return this.http.post(REST_SERVICE_ROOT + '/updateNode/' + node.id, node);
    };
    ClusterRestService.prototype.addClusterNodes = function (node) {
        return this.http.post(REST_SERVICE_ROOT + '/nodes', node);
    };
    ClusterRestService.prototype.deleteClusterNodes = function (node) {
        return this.http.get(REST_SERVICE_ROOT + '/deleteNode/' + node.id);
    };
    ClusterRestService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Injectable */])(),
...
var RestService = /** @class */ (function () {
    ...
    RestService.prototype.getVersionList = function (appName) {
    ...
    RestService.prototype.getObjectDetectedTotal = function (appName, streamId) {
    ...
    RestService.prototype.stopBroadcast = function (appName, id) {
    ...
    RestService.prototype.deleteVoDFile = function (appName, vodName, id, type) {
    ...
    RestService.prototype.getCameraError = function (appName, id) {
     ...
     */
    RestService.prototype.getLiveComments = function (appName, streamId, serviceId, offset, batch) {
     ...
     */
    RestService.prototype.getLiveCommentsCount = function (appName, streamId, serviceId) {
        return this.http.get(REST_SERVICE_ROOT + "/request?_path=" + appName
     ...
     */
    RestService.prototype.getInteraction = function (appName, streamId, serviceId) {
        return this.http.get(REST_SERVICE_ROOT + "/request?_path=" + appName
     ...
     */
    RestService.prototype.getLiveViewsCount = function (appName, streamId, serviceId) {
        return this.http.get(REST_SERVICE_ROOT + "/request?_path=" + appName
     ...
     * This methods get live views count from social endpoint like facebook, youtube,...
     */
    RestService.prototype.getToken = function (appName, streamId, expireDate) {
    ...
    RestService.prototype.moveLeft = function (camera, appName) {
        var streamInfoUrl = REST_SERVICE_ROOT + "/request?_path=" + appName + '/rest/streamSource/moveLeft?id=' + camera.streamId;
        console.log('URL ' + streamInfoUrl);
        return this.http.get(streamInfoUrl);
    };
    ...
    RestService.prototype.validateIPaddress = function (ipaddress) {
        if (/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(ipaddress)) {
            return true;
        }
        return false;
    };
    RestService.prototype.checkStreamUrl = function (url) {
    ...
    RestService.prototype.checkStreamName = function (name) {
    ...
    RestService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]])
    ], RestService);
    return RestService;
}());
...
var FooterComponent = /** @class */ (function () {
    function FooterComponent(locale, http, restService) {
        this.http = http;
        this.restService = restService;
        this.test = new Date();
        if (locale == "en-US") {
    ...
    FooterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.getVersionList("LiveApp").subscribe(function (data) {
            _this.versionName = data["versionName"];
            _this.versionType = data["versionType"];
        });
    };
    FooterComponent = __decorate([
        ...
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Inject */])(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* LOCALE_ID */])),
        __metadata("design:paramtypes", [String, __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__rest_rest_service__["d" /* RestService */]])
    ], FooterComponent);
        ...
        for (var item = 0; item < this.listTitles.length; item++) {
            ...
            if (parent.path === titlee) {
                ...
                if (first_child == "cluster") {
                    return __WEBPACK_IMPORTED_MODULE_4_app_locale_locale__["a" /* Locale */].getLocaleInterface().cluster;
                }
                /*
