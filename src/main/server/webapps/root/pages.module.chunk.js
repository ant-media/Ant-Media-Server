...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(element, auth, http, router) {
        this.element = element;
        this.auth = auth;
        this.http = http;
        this.router = router;
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */], __WEBPACK_IMPORTED_MODULE_2__rest_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]])
    ], LoginComponent);
