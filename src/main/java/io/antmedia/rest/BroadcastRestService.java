...
public class BroadcastRestService extends RestServiceBase {
     ...
     *
     * @param broadcast Broadcast object only related information should be set, it
     *                  may be null as well.
     ...
     * @return deprecated use createBroadcast with listenerHookURL , it will be deleted.
     */
     ...
     *
     * @param broadcast               Broadcast {@link io.antmedia.datastore.db.types.Broadcast}
     ...
     * @param endpointServiceId the id  of the service in order
     ...
     *
     * @param id      This is the id of broadcast
     * @param rtmpUrl RTMP  URL of the endpoint that stream will be republished
     * @return {@link io.antmedia.rest.BroadcastRestService.Result}
     */
     ...
     *
     * @param offset This is the offset of the list, it is useful for pagination,
     * @param size   Number of items that will be fetched. If there is not enough
    ...
    public Result stopMp4Muxing(String streamId) {
        boolean result = false;
        List<MuxAdaptor> muxAdaptors = getMuxAdaptors(streamId);
        for (MuxAdaptor muxAdaptor : muxAdaptors) {
            if (muxAdaptor != null) {
     ...
     *
     * @param serviceName Name of the service, like Facebook, Youtube, Periscope
     ...
     *
     * @param endpointId
     * @param type       This is very service specific, it may be page for Facebook
     * @return List of
