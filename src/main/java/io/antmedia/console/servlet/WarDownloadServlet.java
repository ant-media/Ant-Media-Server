...
public class WarDownloadServlet extends HttpServlet{
	...
	private Logger logger = LoggerFactory.getLogger(WarDownloadServlet.class);
	...
	public void doHead(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException  {
        ...
        if (warFileInTmpDirectory == null) {
			...
			response.sendError(HttpServletResponse.SC_NOT_FOUND, "No such war file in the tmp directory");
			return;
		}
		...
		if (appAdaptor == null) {
			...
			response.sendError(HttpServletResponse.SC_BAD_REQUEST, "No such application");
			return;
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (warFileInTmpDirectory == null) {
			logger.info("No such war file in the tmp directory for app: {} ", appName);
			response.sendError(HttpServletResponse.SC_BAD_REQUEST, "No such war file in the tmp directory");
			return;
		}
