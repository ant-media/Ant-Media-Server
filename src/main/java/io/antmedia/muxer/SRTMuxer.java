...
public class SRTMuxer extends Muxer  {
	...
	public SRTMuxer(Vertx vertx, StorageClient storageClient, String s3StreamsFolderPath, int uploadExtensionsToS3, String httpEndpoint, boolean addDateTimeToResourceName) {
		super(vertx);
	...
	{
    		return "srt://:40052?mode=listener&latency=20000000";
