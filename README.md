...
*   Make rest authentication filter accept requests from defined IP addresses that are in settings [#360](https://github.com/ant-media/Ant-Media-Server/issues/360)
*   Refactor: Unique play.html [#690](https://github.com/ant-media/Ant-Media-Server/issues/690)
*   Refactor: HLS delete files in the edge nodes [#853](https://github.com/ant-media/Ant-Media-Server/issues/853)
...
*   Make web panel accept IP addresses that an app can accept for http requests [#361](https://github.com/ant-media/Ant-Media-Server/issues/361)
*   Add a rest method that accept user assigned stream id [#1007](https://github.com/ant-media/Ant-Media-Server/issues/1007)
*   Update embedded tomcat version [#520](https://github.com/ant-media/Ant-Media-Server/issues/520)
...
*   Configure webrtc port for playing as well [#884](https://github.com/ant-media/Ant-Media-Server/issues/884)
*   Make encoder settings configurable [#826](https://github.com/ant-media/Ant-Media-Server/issues/826)
*   Add auto renew for certificates [#523](https://github.com/ant-media/Ant-Media-Server/issues/523)
...
*   Chance Rest Service method of Mp4Muxing for streams [#798](https://github.com/ant-media/Ant-Media-Server/issues/798)
*   Inconsistency in stream number in dashboard [#547](https://github.com/ant-media/Ant-Media-Server/issues/547)
*   WebRTCApp HLS preview doesn't work in Community Edition [#1014](https://github.com/ant-media/Ant-Media-Server/issues/1014)
*   WebRTC App bug [#965](https://github.com/ant-media/Ant-Media-Server/issues/965)
