...
The architecture of the cluster setup could be found [here](/v1/docs/load-testing#cluster-setup). Introduction to clustering with AntMedia Server could be found [here](/v1/docs/clustering).
